...
// Defaults SAX-JS parser options to not track line/col/position, and not trim/normalize text.
WSDL.prototype.parserOpts = { position: false, trim: false, normalize: false };
...
WSDL.prototype._initializeOptions = function (options) {
  ...
  this.options.parserOpts = options.parserOpts || this.parserOpts;
...
WSDL.prototype.xmlToObject = function(xml, callback) {
  var self = this;
  var p = typeof callback === 'function' ? {} : sax.parser(true, self.options.parserOpts);
  var objectName = null;
  var root = {};
  var schema = {
    Envelope: {
...
WSDL.prototype._parse = function(xml) {
  var self = this,
    p = sax.parser(true, self.options.parserOpts),
    stack = [],
    root = null,
    types = null,
    schema = null,
